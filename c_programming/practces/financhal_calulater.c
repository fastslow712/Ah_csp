...
int main(void){
    ...
    printf("what is your rent cost\n");
    scanf("%d", &rent_cost);;
    printf("what is your utilities cost\n");
    scanf(" %d", &utilities_cost);;
    printf("what is your groceries_cost\n");
    scanf(" %d", &groceries_cost);;
    printf("what is your transport_cost\n");
    ...
    printf("your utilities of %d$ percent is %d of income\n", utilities_cost, utilities_percent);
    printf("your groceries of %d$ percent is %d of income\n", groceries_cost, groceries_percent);
    printf("your transport of %d$ percent is %d of income\n", transport_cost, transport_percent);
